...
public class LoginBean {
  ...
  private String buildJwt(String userName, Set<String> roles) throws Exception {
    ...
    public void createAccount() {
        System.out.println(makeUser(password,"/Users/luisestevez/Desktop/Projects/TravelingGrocery-Engine/TravelingGrocery/system/target/liberty/wlp/bin/securityUtility"));
    }

    private String makeUser(String password, String path) {

        Runtime run = Runtime.getRuntime();
        String s = "";
        try {
            Process pr = run.exec("bash " + path + " encode --encoding=hash " + password);
            ...
            pr.waitFor();
            pr.destroy();
        } catch (Exception e) { System.out.println("bad stuff"); }
        return "<user name=\""+username+"\""+" password=\""+s+"\"/> ";
    }
